...
class Menu extends \yii\widgets\Menu
{
     ...
     * @inheritdoc
     */
    public $linkTemplate = '<a href="{url}" class="{class}">{icon} {label}</a>';
    /**
     * @inheritdoc
     * Styles all labels of items on sidebar by Adminto
     */
    public $labelTemplate = '<span>{label}</span>';
    public $submenuTemplate = "\n<li class='has_sub' >\n{items}\n</li>\n";
    public $activateParents = true;
    public $defaultIconHtml = '<i class="zmdi"></i> ';

    /**
     * @var string is prefix that will be added to $item['icon'] if it exist.
     * By default uses for ZMDI
     */
    public static $iconClassPrefix = 'zmdi';
    ...
    protected function renderItem($item)
    {
        ...
        $replacements = [
            ...
            '{class}'=> $this->isItemActive($item['url']) ? 'waves-effect active':'waves-effect',
        ];
