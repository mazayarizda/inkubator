...
<html>
<head>
<title>TIF | Inklubator TIF</title>
...
<div class="ban-top">
	<div class="container">
				...
				<div class="collapse navbar-collapse menu--shylock" id="bs-example-navbar-collapse-1">
				  <ul class="nav navbar-nav menu__list">
					...
					<li class="dropdown menu__item">
						<a href="#" class="dropdown-toggle menu__link" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Profil <span class="caret"></span></a>
								...
								<div class="agile_inner_drop_nav_info">
									...
									<div class="col-sm-3 multi-gd-img">
										<ul class="multi-column-dropdown">
											<li><a href="mens.html">Inkubator</a></li>
											<li><a href="mens.html">Visi &amp; Misi</a></li>
											<li><a href="mens.html">Sejarah</a></li>
											<li><a href="mens.html">Struktur Organisasi</a></li>
										</ul>
									</div>
									<div class="clearfix"></div>
								</div>
						...
						<a href="#" class="dropdown-toggle menu__link" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Product <span class="caret"></span></a>
							<ul class="dropdown-menu multi-column columns-3">
								<div class="agile_inner_drop_nav_info">
									<div class="col-sm-3 multi-gd-img">
										<ul class="multi-column-dropdown">
											<li><a href="womens.html">Edukasi</a></li>
											<li><a href="womens.html">Augmented Reality</a></li>
											<li><a href="womens.html">Ekonomi</a></li>
											<li><a href="womens.html">Sosial</a></li>
											<li><a href="womens.html">Budaya</a></li>
											<li><a href="womens.html">Matematika</a></li>
											<li><a href="womens.html">Sistem Informasi Geografis</a></li>
										</ul>
									</div>
									<div class="col-sm-3 multi-gd-img">
										<ul class="multi-column-dropdown">
											<li><a href="womens.html">JST</a></li>
											<li><a href="womens.html">NLP</a></li>
											<li><a href="womens.html">Location Base Service</a></li>
											<li><a href="womens.html">Aplikasi Mobile</a></li>
											<li><a href="womens.html">Aplikasi</a></li>
											<li><a href="womens.html">Aplikasi</a></li>
											<li><a href="womens.html">Aplikasi</a></li>
										</ul>
									</div>
					...
					<li class="menu__item dropdown">
					   <a class="menu__link" href="#" class="dropdown-toggle" data-toggle="dropdown">How To <b class="caret"></b></a>
								<ul class="dropdown-menu agile_short_dropdown">
									<li><a href="icons.html">Download</a></li>
									<li><a href="typography.html">Purchase</a></li>
								</ul>
					</li>
		...
		<div class="top_nav_right">
			<div class="wthreecartaits wthreecartaits	2 cart cart box_1"> 
						<form action="#" method="post" class="last"> 
						<input type="hidden" name="cmd" value="_cart">
						<input type="hidden" name="display" value="1">
						<button class="w3view-cart" type="submit" name="submit" value=""><i class="fa fa-user -arrow-down" aria-hidden="true"></i> </button>
